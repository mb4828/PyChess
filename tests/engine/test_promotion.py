...
class TestPromotionDetection:
    def test_light_pawn_can_reach_promotion_rank(self):
        ...
        board[7][4] = 'kl'
        board[0][4] = 'kd'
        board[1][3] = 'pl'  # one square from promotion
        board[1][3] = ''
        moves = get_valid_moves(board, 'pl', 1, 3)
    ...
    def test_dark_pawn_can_reach_promotion_rank(self):
        ...
        board[7][4] = 'kl'
        board[0][4] = 'kd'
        board[6][3] = 'pd'  # one square from promotion
        board[6][3] = ''
        moves = get_valid_moves(board, 'pd', 6, 3)
