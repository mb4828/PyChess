...
class TestStalemate:
    def test_basic_stalemate(self):
        ...
        board = empty_board()
        board[0][0] = 'kd'
        board[1][2] = 'ql'  # queen controls row 1 and column 2
        board[2][1] = 'kl'  # king controls (1,0), (1,1), (1,2)
    ...
    def test_not_stalemate_when_in_check(self):
        ...
        board = empty_board()
        board[0][0] = 'kd'
        board[0][7] = 'rl'  # rook giving check
        board[7][4] = 'kl'
    ...
    def test_stalemate_king_cornered_by_queen(self):
        ...
        board = empty_board()
        board[7][7] = 'kl'
        board[5][6] = 'qd'  # queen blocks row 6 and col 6
        board[0][0] = 'kd'
        ...
        board = empty_board()
        board[0][0] = 'kl'
        board[2][1] = 'qd'  # queen at (2,1) attacks (1,0), (1,1), (0,1)
        board[7][7] = 'kd'
    ...
    def test_not_stalemate_other_pieces_can_move(self):
        ...
        board[1][2] = 'ql'
        board[2][1] = 'kl'
        board[5][5] = 'pd'  # dark pawn can still move
        assert is_in_stalemate(board, 'd') is False
